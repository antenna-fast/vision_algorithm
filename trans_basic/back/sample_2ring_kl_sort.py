...
savetxt('save_file/key_pts_buff_1_k_' + str(vici_num-1) + '.txt', key_pts_buff_1)
...
savetxt('save_file/key_pts_buff_2_k_' + str(vici_num-1) + '.txt', key_pts_buff_2)
