...
# if 1:
    ...
    # vici_pts_1
    # 二环
    # for now_pt_2r in all_pts:  # 比较二环及其本身 方差的区别
    var_buff = []
    for now_pt_2r in idx_1:  # 比较二环及其本身 方差的区别
        now_pt_1_2 = array(pcd.points[now_pt_2r])  # 每一个 相对中心点
        ...
        var_buff.append(var_cos)

    # 如果当前邻域的离散程度超过阈值，就标记出
    vici_var = var(var_buff)
    if vici_var > threshold:
        pcd.colors[pick_idx] = [1, 0, 0]  # 选一个点
...
# if 1:
    ...
    # for now_pt_2r in all_pts:  # 比较二环及其本身 方差的区别
    var_buff = []
    for now_pt_2r in idx_2:  # 比较二环及其本身 方差的区别
        now_pt_2_2 = array(pcd2.points[now_pt_2r])  # 中心点
        ...
        all_pts = array(pcd2.points)[idx_2_2]
