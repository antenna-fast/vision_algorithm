...
pcd.paint_uniform_color([0, 0.8, 0.5])
...
if 1:
    ...
    mesh1, mesh_normals, vtx_normal = get_mesh(now_pt, vici_pts)
    print('mesh_normals:\n', mesh_normals)
    print('mesh2:', mesh1)
...
# mesh2, mesh2_normals, vtx_nermal = get_mesh(now_pt, vici_pts)
# print(dir(mesh))
...
if 1:
    ...
    # print("Find its nearest neighbors, and paint them blue.")
    [k, idx, _] = pcd_tree.search_knn_vector_3d(pcd2.points[pick_idx], vici_num)
    vici_idx = idx[1:]
    # asarray(pcd2.colors)[vici_idx, :] = [0, 0, 1]
    ...
    mesh2, mesh_normals2, vtx_normal2 = get_mesh(now_pt, vici_pts)
    print('mesh_normals2:\n', mesh_normals2)
    print('mesh2:', mesh2)
